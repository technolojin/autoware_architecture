...
"""Refactored launcher generation script using modern architecture."""
...
def generate_launcher(module_yaml_dir, executable_name, launch_file_dir) -> None:
    ...
    try:
        # Load module element
        module = ElementFactory.create_element(module_yaml_dir)
        ...
        launcher_path = launcher_generator.generate_module_launcher(
            ...
            output_dir=launch_file_dir
        )
        
        print(f"Generated launcher file: {launcher_path}")
        
    except Exception as exc:
        print(f"Error generating launcher: {exc}")
        raise
