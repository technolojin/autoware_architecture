...
macro(autoware_architect_build_deploy project_name)
  ...
  if("${_INPUT_NAME}" STREQUAL "")
    message(FATAL_ERROR "autoware_architect_build_deploy: empty file base name")
  endif()
  ...
  if(_INPUT_NAME MATCHES ".*\\.architecture$")
    set(_DEPLOYMENT_FILE "${CMAKE_SOURCE_DIR}/architecture/architectures/${_INPUT_NAME}.yaml")
